...
export default function ApplicationDetailPage() {
 ...
 className="inline-flex items-center space-x-1.5 px-3.5 py-2 rounded-xl bg-purple-600/10 hover:bg-purple-600/20 text-purple-600 border border-purple-500/20 font-bold text-xs transition-all"
 >
 ...
 className="inline-flex items-center space-x-2 text-indigo-600 hover:underline font-bold text-sm mt-1"
 >
 ...
 <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Status Lamaran</label>
 <select
 value={application.status}
 onChange={(e) => handleStatusChange(e.target.value as ApplicationStatus)}
 className="px-4 py-2 rounded-xl text-xs font-bold bg-indigo-600 text-white focus:outline-none shadow-lg shadow-indigo-500/25"
 >
 ...
 <span className="text-slate-400 font-bold uppercase tracking-wider block mb-1">Tanggal Apply</span>
 ...
 <div className="p-4 rounded-xl bg-slate-100 border border-slate-200">
 <span className="text-slate-400 font-bold uppercase tracking-wider block mb-1">Range Gaji</span>
 <div className="flex items-center space-x-1.5 font-bold text-slate-800">
 ...
 <div className="p-4 rounded-xl bg-slate-100 border border-slate-200">
 <span className="text-slate-400 font-bold uppercase tracking-wider block mb-1">Kontak HR</span>
 <div className="flex items-center space-x-1.5 font-bold text-slate-800">
 ...
 <span className="text-xs text-indigo-600 font-bold">Portal / Link Lowongan Asli</span>
 <a
 ...
 <div className="flex items-center justify-between">
 <h3 className="font-bold text-sm text-slate-900">Catatan Tambahan</h3>
 <button
 ...
 className="inline-flex items-center space-x-1 px-3 py-1.5 rounded-lg bg-indigo-600 text-white font-bold text-xs"
 >
 ...
 <div className="space-y-2">
 <h3 className="font-bold text-sm text-slate-900">Archived Job Description</h3>
